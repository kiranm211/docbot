...
class DictLoader(BaseLoader):
    ...
    >>> loader = DictLoader({'search.html': 'source here'})
...
class PrefixLoader(BaseLoader):
    ...
    By loading ``'app1/search.html'`` the file from the app1 package is loaded,
    by loading ``'app2/search.html'`` the file from the second.
    """
